    ...
    const steps: Step[] = [
        ...
        },
        {
            ...
            content: [
                ...
                {
                    title: "Module 3: Advanced Operational Excellence",
                    type: "module",
                                                        ...
                                                        {step.content.map((item: any, i: number) => (
                                                            <div key={i} className="relative pl-6 pb-6 last:pb-0">
                                                                <div className={cn(
                                                                    ...
                                                                    (step.status === "completed" && item.title !== "Module 3: Advanced Operational Excellence") ? "border-emerald-500 bg-emerald-50" : "border-gray-300 bg-gray-50"
                                                                )}></div>
